...
urlpatterns = [
    ...
    path('google34c875193a5d51bc.html', lambda r: __import__('django.http', fromlist=['HttpResponse']).HttpResponse('<html><head><meta name="google-site-verification" content="34c875193a5d51bc" /></head><body>google-site-verification: google34c875193a5d51bc.html</body></html>', content_type='text/html; charset=utf-8'), name='google_verify'),
]
